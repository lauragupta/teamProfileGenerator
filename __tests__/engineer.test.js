...
describe("Engineer class", () =>{
    describe("Initialization", () => {
        ...
        it("should throw an error if 'name' is not a string", () => {
            //Act
            const cb = () => new Engineer(5, "ss@Hogwarts.edu", 3, "severussnape");
        ...
        it("should throw an error if 'email' is not a string", () => {
            //Act
            const cb = () => new Engineer("Severus Snape", 77, 3, "severussnape");
        ...
        it("should throw an error if 'id' less than 0", () => {
            //Act
            const cb = () => new Engineer("Severus Snape", "ss@Hogwarts.edu", -3, "severussnape");
        ...
        it("should throw an error if 'officeNumber' less than 0", () => {
            //Act
            const cb = () => new Engineer("Severus Snape", "ss@Hogwarts.edu", 3, 88);
