...
function renderManagerCard(name, email, id, office) {
    return `<div class="column"><h2 class="is-size-2 has-background-link has-text-light">Name: ${name}</h2><h3 class="is-size-3 has-background-link has-text-light">Manager</h2><p>ID: ${id}</p><p>Email: <a href="mailto:${email}">${email}</a></p><p>Office number: ${office}</p></div>`
} 
    
//function to make engineer html cards
function renderEngineerCard(name, email, id, githubUsername) {
    return `<div class="column"><h2 class="is-size-2 has-background-link has-text-light">Name: ${name}</h2><h3 class="is-size-3 has-background-link has-text-light">Engineer</h2><p>ID: ${id}</p><p>Email: <a href="mailto:${email}">${email}</a></p><p><a href="https://github.com/${githubUsername}" target="_blank">Check out my code on GitHub!</a></p></div>`
} 
